...
Implementa os requisitos funcionais:
...
RNF02 - Apenas lógica de negócio neste módulo. Testes ficam
        isolados em tests/test_sistema_reservas.py.

RNF03 - Todas as operações são em memória, com tempo de resposta
        muito abaixo do limite de 3 segundos exigido.
"""
...
class SistemaReservas:
    ...
    def realizar_reserva(
        ...
        Regras:
        - Aluno precisa estar cadastrado (senão: AlunoNaoEncontradoError).
        - Sala precisa existir (senão: SalaNaoEncontradaError).
        - RF04: mesma sala no mesmo horário é bloqueada (HorarioOcupadoError).
        """
